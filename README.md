...
![AgenticDataQuality Architecture](docs/architecture.svg)

### Agent Flow

| Step | Agent | Purpose |
|------|-------|---------|
| 1 | **Data Profiler** | Analyzes schema, completeness, uniqueness, CDE identification |
| 2 | **Data Validator** | Validates against business rules, format checks, CDE requirements |
| 3 | **Anomaly Detector** | Identifies outliers using IQR method, statistical analysis |
| 4 | **Report Writer** | Synthesizes findings into comprehensive DQ assessment |
| 5 | **Senior Editor** | *(Optional)* Polishes report for executive presentation |
